...
export default function Navbar({ currentTab, isNotHome = false }): JSX.Element {
        ...
        <ul className="dis-row">
          <li>
            <a
              href="/"
              className={`${
                currentTab == "HOME" ? "active-link-top-menu" : ""
              }`}
            >
              Home
            </a>
          ...
          <li>
            <a
              href="/services"
              className={`${
                currentTab == "SERVICES" ? "active-link-top-menu" : ""
              }`}
            >
              Services
            </a>
          ...
          <li>
            <a
              href="/blogs"
              className={`${
                currentTab == "BLOGS" ? "active-link-top-menu" : ""
              }`}
            >
              Blogs
            </a>
          ...
          <li>
            <a
              href="/pricing"
              className={`${
                currentTab == "PRICING" ? "active-link-top-menu" : ""
              }`}
            >
              Pricing
            </a>
          ...
          <li>
            <a
              href="/contact"
              className={`${
                currentTab == "CONTACT" ? "active-link-top-menu" : ""
              }`}
            >
              Contact
            </a>
